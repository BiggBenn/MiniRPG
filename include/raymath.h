...
inline bool Vector2Equals(Vector2 v1, Vector2 v2)
{
...
//define operator for vector subtraction
...
{
    float result = abs(Vector2Length(v1 - v2));
    return result;
}

inline float Vector2DistanceSquared(Vector2 v1, Vector2 v2)
{
    float result = abs(Vector2LengthSquared(v1 - v2));
    return result;
}
...
inline Vector2 operator * (Vector2 v, float scale)
{
...
//define operator for vector multiplication
inline Vector2 operator * (Vector2 v1, Vector2 v2)
{
    return Vector2MultiplyV(v1, v2);
}
...
//define operator for divison
inline Vector2 operator / (Vector2 v, float div)
{
    return Vector2Divide(v, div);
}
...
//define operator for vector divison
inline Vector2 operator / (Vector2 v1, Vector2 v2)
{
    return Vector2DivideV(v1, v2);
}
...
RMDEF Vector2 Vector2Normalize(Vector2 v)
{
    ...
    if(length != 0)
        result = Vector2Divide(v, Vector2Length(v));
    return result;
}
...
RMDEF float Vector2Angle(Vector2 v1, Vector2 v2)
{
    ...
    float result = atan2f(v2.y - v1.y, v2.x - v1.x) * (360.0f / PI);
...
inline bool Vector3Equals(Vector3 v1, Vector3 v2)
{
...
//define operator for divison
inline Vector3 operator / (Vector3 v, float div)
{
    return Vector3Divide(v, div);
}
