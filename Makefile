...
OBJS:=main.o GameObject.o Player.o Scene.o SceneManager.o AssetManager.o Dialogue.o DialogueExecutor.o DialogueBuilder.o MiniGameScene.o ButtonMashScene.o Egg.o Weed.o
